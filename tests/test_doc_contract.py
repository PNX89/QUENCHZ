...
IMPLEMENTATIONS: dict[str, str] = {
    "NUMBER": "test_the_readme_coverage_block_matches_the_committed_cassette",
    "COMMAND": "test_every_command_the_readme_shows_is_one_this_repository_runs",
    "OUTPUT": "test_the_readme_response_body_is_the_one_the_server_returns",
    "REFERENCE": "test_every_path_and_link_in_the_readme_resolves",
}
...
def _resolves(claim: str) -> bool:
    ...
    `quenchz/thing.py` because that is the import path a reader types, and the file is at
    `src/quenchz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
