...
```bash
git clone https://github.com/PNX89/QUENCHZ.git && cd QUENCHZ
uv sync --dev
...
- proved from outside the Python tree
...
https://pnx89.github.io/QUENCHZ, come from a real run whose output is committed under
